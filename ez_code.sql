...
CREATE TABLE `sys_authority`  (
  ...
  PRIMARY KEY (`ID`) USING BTREE,
  UNIQUE INDEX `INDEX_UNIQUE_CODE`(`AUTHORITY_CODE`) USING BTREE,
  INDEX `INDEX_AUTHORITY_CODE`(`AUTHORITY_CODE`) USING BTREE
...
CREATE TABLE `sys_resource`  (
  ...
  UNIQUE INDEX `INDEX_UNIQUE_RESOURE_ID`(`RESOURCE_ID`) USING BTREE
...
CREATE TABLE `sys_role`  (
  ...
  UNIQUE INDEX `INDEX_UNIQUE_ROLE_CODE`(`ROLE_CODE`) USING BTREE
...
CREATE TABLE `sys_user`  (
  ...
  UNIQUE INDEX `INDEX_UNIQUE_USER_ID`(`USER_ID`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
